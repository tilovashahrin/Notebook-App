...
export function NotesList({ availableTags, notes, onUpdateTag, onDeleteTag }: NotesListProps) {
...
export function EditTagsModal(
    { availableTags, show, handleClose, onUpdateTag, onDeleteTag }: EditTagsModalProps) {
